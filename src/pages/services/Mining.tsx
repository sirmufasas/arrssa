...
export default function Mining() {
  return <>
    <SEO title="Mining & Resources | ARSSA" description="ARSSA supports mining-related sourcing, partnerships and commercial coordination across the South Africa (SADAC)–DRC corridor." path="/services/mining" />
