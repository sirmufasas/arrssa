...
const BLOCKS: ServiceBlock[] = [
  ...
  { icon: Handshake, title: "Partnerships & Sourcing", items: ["South Africa (SADC)–DRC business connections", "Equipment and input sourcing", "Stakeholder coordination"] },
...
export default function Mining() {
  return <>
    <SEO title="Mining & Resources | ARSSA" description="ARSSA supports mining-related sourcing, partnerships and commercial coordination across the South Africa (SADC)–DRC corridor." path="/services/mining" />
