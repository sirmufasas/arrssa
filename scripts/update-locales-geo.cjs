...
const UPDATES = {
  en: {
    ...
    regionalTab: "Corridor & Regional (Southern Africa & DRC)",
  },
  fr: {
    badge: "Corridor Commercial RDC–Afrique Australe",
    ...
    miningDesc: "Accompagnement pratique pour l'approvisionnement minier, placement de main-d'œuvre, partenariats stratégiques et coordination commerciale sur le corridor commercial RDC–Afrique australe.",
    ...
    footerDesc: "Basée en République Démocratique du Congo avec une présence établie en Afrique du Sud, ARSSA relie les entreprises, fournisseurs et opportunités entre la RDC et l'Afrique australe.",
    footerLocation: "Présence Établie en Afrique du Sud — desservant le corridor commercial RDC–Afrique australe",
    regionalTab: "Langues Régionales & Corridor (Afrique Australe & RDC)",
  },
  pt: {
    ...
    miningDesc: "Apoio prático para aprovisionamento mineiro, colocação de força de trabalho, parcerias e coordenação comercial no corredor comercial RDC–África Austral.",
    ...
    footerDesc: "Com sede na República Democrática do Congo e presença estabelecida na África do Sul, a ARSSA conecta empresas, fornecedores e oportunidades entre a RDC e a África Austral.",
    footerLocation: "Presença Estabelecida na África do Sul — servindo o corredor comercial RDC–África Austral",
    regionalTab: "Corredor & Regional (África Austral & RDC)",
  },
  sw: {
    ...
    miningDesc: "Usaidizi madhubuti wa ununuzi wa vifaa vya migodi, upangaji wa nguvu kazi, ushirikiano na uratibu wa kibiashara katika ukanda wa DRC–Kusini mwa Afrika.",
    ...
    footerDesc: "Ikiwa na makao makuu katika Jamhuri ya Kidemokrasia ya Kongo na uwepo thabiti nchini Afrika Kusini, ARSSA inaunganisha biashara, wasambazaji na fursa kati ya DRC na Kusini mwa Afrika.",
    footerLocation: "Uwepo Thabiti Afrika Kusini — inahudumia ukanda wa biashara wa DRC–Kusini mwa Afrika",
    regionalTab: "Ukanda & Kanda (Kusini mwa Afrika & DRC)",
  },
  ln: {
    ...
    miningDesc: "Lisalisi ya solo mpo na kozwa biloko ya mabele ya talo, kozwa basali, boyokani mpe kokamba mombo na nzela ya DRC–Afríka ya Súdi.",
    corridorTitle: "Nzela ya Mombo RDC–Afríka ya Súdi na Zoni",
    corridorDesc: "Kopanisa mombo na RDC mpe Afríka ya Súdi esengaka boyebi ya mozindo ya mboka, kotosa mibeko mpe nzela ya kotinda biloko ya solosolo. ARSSA elongolaka mikakatano nyonso.",
    ...
    footerDesc: "Kitelemisi monene na République Démocratique du Congo mpe esika ya mosala na Afríka ya Súdi, ARSSA ekangisaka bakompani mpe mabaku ya mombo.",
    footerLocation: "Kozala na Afríka ya Súdi — kosalela nzela ya mombo RDC–Afríka ya Súdi na zoni",
    regionalTab: "Nzela ya Mombo & Minoko ya Zoni (Afríka ya Súdi & RDC)",
  },
  af: {
    ...
    footerDesc: "Met sy hoofkantoor in die Demokratiese Republiek van die Kongo en 'n gevestigde Suid-Afrikaanse teenwoordigheid, verbind ARSSA besighede, verskaffers en geleenthede tussen die DRK en Suider-Afrika.",
    footerLocation: "Gevestigde Suid-Afrikaanse Teenwoordigheid — bedien die DRK–Suider-Afrika-handelskorridor",
    regionalTab: "Korridor & Streektale (Suider-Afrika & DRK)",
  },
  zu: {
    ...
    footerDesc: "Ikomkhulu layo liseDemocratic Republic of Congo kanti inobukhona obuqinile eNingizimu Afrika, i-ARSSA ixhumanisa amabhizinisi namathuba phakathi kwe-DRC neNingizimu Afrika yonkana.",
    footerLocation: "Ubukhona Obumisiwe eNingizimu Afrika — sikhonza iphasishi lokuhweba le-DRC–Ningizimu Afrika",
    regionalTab: "Iphasishi & Isifunda (Ningizimu Afrika & DRC)",
  },
  xh: {
    ...
    importExportDesc: "Uququzelelo lorhwebo, ukuthotyelwa kwemithetho yeempahla, ulogistiki nokuthuthwa kweempahla kummandla woRhwebo wase-DRC–Mazantsi e-Afrika.",
    miningDesc: "Inkxaso esebenzayo yokufumana izixhobo zokumba, ukubekwa kwabasebenzi, ubudlelwane kunye nolungelelaniso lorhwebo kumda we-DRC–Mazantsi e-Afrika.",
    ...
    footerDesc: "Ikomkhulu liseDemocratic Republic of Congo kwaye inobukho obusekweleyo eMzantsi Afrika, i-ARSSA idibanisa amashishini namathuba phakathi kwe-DRC noMzantsi Afrika jikelele.",
    footerLocation: "Ubukho Obumisiweyo eMzantsi Afrika — sikhonza indlela yoRhwebo yase-DRC–Mazantsi e-Afrika",
    regionalTab: "Indlela & UmMandla (Mazantsi e-Afrika & DRC)",
  },
  zh: {
    badge: "刚果（金）–南部非洲商业贸易走廊",
    heroSub: "依托端到端的运营、法规合规与实地网络，深度连通刚果（金）与南部非洲各主要市场。",
    importExportDesc: "依托刚果（金）–南部非洲核心贸易走廊，提供进出口通关、海关合规、国际物流与货运供应链一体化服务。",
    miningDesc: "为刚果（金）–南部非洲矿业走廊提供设备采购、专业人才派遣配置、备件供应与跨国商业落地协同。",
    ...
    footerDesc: "总部设立于刚果民主共和国，并在南非拥有成熟的常设运营实体，ARSSA 紧密连接刚果（金）与南部非洲各国的企业、供应商与广阔商业机遇。",
    footerLocation: "扎根南非实体运营 — 全面服务刚果（金）–南部非洲经贸走廊",
    regionalTab: "经贸走廊与区域语言 (南部非洲 & 刚果金)",
  },
  ar: {
    ...
    footerDesc: "يقع مقرها الرئيسي في جمهورية الكونغو الديمقراطية ولديها وجود تشغيلي راسخ في جنوب أفريقيا، وتربط ARSSA بين الشركات والموردين والفرص بين الكونغو الديمقراطية والجنوب الأفريقي.",
    footerLocation: "تواجد تشغيلي راسخ في جنوب أفريقيا — خدمة ممر التجارة مع جمهورية الكونغو الديمقراطية والجنوب الأفريقي",
    regionalTab: "لغات الممر التجاري والإقليمي (الجنوب الأفريقي والكونغو الديمقراطية)",
  },
  es: {
    badge: "Corredor Comercial RDC–África Austral",
    ...
    miningDesc: "Apoyo práctico para abastecimiento minero, dotación de personal técnico, alianzas comerciales y suministros en el corredor RDC–África Austral.",
    ...
    footerDesc: "Con sede en la República Democrática del Congo y presencia establecida en Sudáfrica, ARSSA conecta empresas, proveedores y oportunidades entre la RDC y el África Austral.",
    footerLocation: "Presencia Establecida en Sudáfrica — sirviendo al corredor comercial RDC–África Austral",
    regionalTab: "Corredor y Regional (África Austral y RDC)",
  },
  de: {
    ...
    miningDesc: "Praktische Unterstützung bei bergbaubezogener Beschaffung, Fachkräftevermittlung, Partnerschaften und kommerzieller Koordination im Handelskorridor DR Kongo–Südliches Afrika.",
    ...
    footerDesc: "Mit Hauptsitz in der Demokratischen Republik Kongo und einer etablierten Präsenz in Südafrika verbindet ARSSA Unternehmen, Lieferanten und Geschäftsmöglichkeiten zwischen der DR Kongo und dem südlichen Afrika.",
    footerLocation: "Etablierte Präsenz in Südafrika — im Einsatz für den Handelskorridor DR Kongo–Südliches Afrika",
    regionalTab: "Korridor & Regionale Sprachen (Südliches Afrika & DR Kongo)",
  },
  hi: {
    badge: "डीआरसी-दक्षिणी अफ्रीका वाणिज्यिक गलियारा",
    ...
    footerDesc: "कांगो लोकतांत्रिक गणराज्य में मुख्यालय और दक्षिण अफ्रीका में स्थापित उपस्थिति के साथ, ARSSA व्यवसायों, आपूर्तिकर्ताओं और अवसरों को डीआरसी और दक्षिणी अफ्रीका के बीच जोड़ता है।",
    footerLocation: "दक्षिण अफ्रीका में स्थापित उपस्थिति — डीआरसी-दक्षिणी अफ्रीका व्यापार गलियारे की सेवा",
    regionalTab: "गलियारा और क्षेत्रीय भाषाएं (दक्षिणी अफ्रीका और डीआरसी)",
  },
  ru: {
    badge: "Торговый коридор ДРК – Южная Африка",
    ...
    miningDesc: "Практическое содействие в закупках для горнодобывающей отрасли, подборе кадров, партнерствах и коммерческой координации по коридору ДРК – Южная Африка.",
    ...
    footerDesc: "Штаб-квартира в Демократической Республике Конго и постоянное операционное присутствие в ЮАР позволяют ARSSA соединять бизнес, поставщиков и возможности между ДРК и Южной Африкой.",
    footerLocation: "Постоянное присутствие в ЮАР — обслуживание торгового коридора ДРК – Южная Африка",
    regionalTab: "Коридор и региональные языки (Южная Африка и ДРК)",
  },
  ja: {
    badge: "コンゴ民主共和国–南部アフリカ商業貿易回廊",
    ...
    footerDesc: "コンゴ民主共和国に本社を置き、南アフリカに強固な事業拠点を有する ARSSA は、コンゴ民主共和国と南部アフリカ全域の企業、サプライヤー、商業機会を結びます。",
    footerLocation: "南アフリカにおける確立された事業基盤 — コンゴ民主共和国–南部アフリカ貿易回廊に対応",
    regionalTab: "回廊・地域言語 (南部アフリカ & コンゴ民主共和国)",
  },
  ko: {
    ...
    footerDesc: "콩고민주공화국에 본사를 두고 남아프리카공화국에 확고한 현지 거점을 둔 ARSSA는 콩고민주공화국과 남부 아프리카 전역의 기업, 공급업체 및 상업적 기회를 연결합니다.",
    footerLocation: "남아프리카공화국 현지 거점 — 콩고민주공화국–남부 아프리카 무역 회랑 지원",
    regionalTab: "회랑 및 지역 언어 (남부 아프리카 & 콩고민주공화국)",
  },
  it: {
    ...
    miningDesc: "Supporto pratico per l'approvvigionamento minerario, collocamento della manodopera, partnership e coordinamento commerciale nel corridoio RDC–Africa australe.",
    ...
    footerDesc: "Con sede nella Repubblica Democratica del Congo e una presenza consolidata in Sudafrica, ARSSA collega aziende, fornitori e opportunità tra la RDC e l'Africa australe.",
    footerLocation: "Presenza Consolidata in Sudafrica — al servizio del corridoio commerciale RDC–Africa australe",
    regionalTab: "Corridoio e Lingue Regionali (Africa Australe & RDC)",
  },
  nl: {
    ...
    footerDesc: "Met het hoofdkantoor in de Democratische Republiek Congo en een gevestigde aanwezigheid in Zuid-Afrika, verbindt ARSSA bedrijven, leveranciers en kansen tussen de DRC en Zuidelijk Afrika.",
    footerLocation: "Gevestigde Aanwezigheid in Zuid-Afrika — ten dienste van de handelscorridor DRC–Zuidelijk Afrika",
    regionalTab: "Corridor & Regionale Talen (Zuidelijk Afrika & DRC)",
  },
};
...
for (const [lang, u] of Object.entries(UPDATES)) {
  ...
  // Replace badge in hero
  content = content.replace(/"badge":\s*"[^"]*",(\s*"headline1")/, `"badge": "${u.badge}",$1`);
  // Replace subtitle in divisionsSection
  content = content.replace(/"subtitle":\s*"[^"]*",(\s*"tabTitle")/, `"subtitle": "${u.heroSub}",$1`);
  // Replace import-export description
  content = content.replace(/(slug:\s*"import-export"[\s\S]*?"description":\s*)"[^"]*"/, `$1"${u.importExportDesc}"`);
  // Replace mining description
  content = content.replace(/(slug:\s*"mining"[\s\S]*?"description":\s*)"[^"]*"/, `$1"${u.miningDesc}"`);
  // Replace corridor title & desc
  content = content.replace(/(corridor:\s*\{[\s\S]*?"title":\s*)"[^"]*"/, `$1"${u.corridorTitle}"`);
  content = content.replace(/(corridor:\s*\{[\s\S]*?"desc":\s*)"[^"]*"/, `$1"${u.corridorDesc}"`);
  // Replace cta text
  content = content.replace(/(cta:\s*\{[\s\S]*?"text":\s*)"[^"]*"/, `$1"${u.ctaText}"`);
  // Replace footer desc & location & regionalTab
  content = content.replace(/(footer:\s*\{[\s\S]*?"desc":\s*)"[^"]*"/, `$1"${u.footerDesc}"`);
  content = content.replace(/(footer:\s*\{[\s\S]*?"location":\s*)"[^"]*"/, `$1"${u.footerLocation}"`);
  content = content.replace(/(footer:\s*\{[\s\S]*?"regionalTab":\s*)"[^"]*"/, `$1"${u.regionalTab}"`);
